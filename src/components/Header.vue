...
<template>
  <header class="fixed top-0 left-0 right-0 z-30 bg-main text-textAccent rounded-b-2xl">
    ...
    >
      ...
      <div class="w-full flex flex-col gap-5 pt-5 sm:gap-10 sm:pt-20">
        <Button
          as="a"
          rel="noopener"
          rounded
          ...
          class="font-medium py-2 px-6 border-transparent bg-main hover:bg-mainHover shadow-authButton tracking-wide sm:py-5 active:translate-y-px"
        >
