...
<template>
  <header class="bg-main text-textAccent rounded-b-2xl">
    <div class="w-viewport max-w-full mx-auto px-main py-4 flex items-center gap-4 sm:gap-12">
      ...
      <div class="flex-none flex gap-4">
        ...
        <button
          ...
          class="w-10 h-10 flex items-center justify-center bg-bgSecondaryColor rounded-full"
          type="button"
        >
    ...
    >
      <template #header>
        <Button
          class="bg-bgColor hover:bg-main text-textMain hover:text-textAccent border-transparent p-3"
      ...
      <template #footer>
        ...
        <Button
          ...
          class="w-full gap-6 justify-start text-textAccent bg-transparent border-transparent text-left px-4 py-6 hover:bg-linkHover tracking-wide"
      ...
      <div class="w-full flex flex-col gap-5 pt-5 mobile:gap-10 mobile:pt-20">
        <Button
          ...
          class="font-medium py-2 px-6 border-transparent bg-main hover:bg-mainHover shadow-AuthButton tracking-wide mobile:py-5"
        >
