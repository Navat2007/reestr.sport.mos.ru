...
const activityTypes = computed(() => {
  let array = [
    ...
    'Деятельность концертных залов, театров, оперных зданий, мюзик-холлов, включая услуги билетных касс',
    'Деятельность организаций по проведению культурных и развлекательных мероприятий',
    ...
    'Производство спортивных костюмов, лыжных костюмов, купальных костюмов и прочих костюмов из текстильных материалов, кроме трикотажных или вязаных',
    ...
    'Ремонт спортивного и туристского оборудования',
    'Рыболовство любительское и спортивное',
